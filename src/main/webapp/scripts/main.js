(function() {
  ...
  function changeFavoriteItem(item_id, isLikeBtn) {
    ...
    var likeBtn = document.querySelector('#like-icon-' + item_id);
    var dislikeBtn = document.querySelector('#dislike-icon-' + item_id);
  ...
  function addItem(itemList, item) {
    ...
    likeBtn.onclick = function() {
        changeFavoriteItem(item_id, true);
    };
    
    let dislikeBtn = $create('i', {
        id: 'dislike-icon-' + item_id,
        className: dislikeImg
    });
  
    dislikeBtn.onclick = function() {
        changeFavoriteItem(item_id, false);
    };
    
    favLink.appendChild(likeBtn);
    favLink.appendChild(dislikeBtn);
